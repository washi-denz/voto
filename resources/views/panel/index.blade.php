...
<section class="bg-gray-50 w-full h-1/2 relative">
    ...
    <div class="container mx-auto lg:px-20 md:px-8 sm:px-16"> 
       ...
       <div class="absolute top-1/3 transform -translate-y-1/3 pl-3">
            <h1 class="mb-4 font-thin text-indigo-500 font-mono text-4xl sm:text-6xl tracking-widest inline">Hola</h1><span class="text-lg text-indigo-500">,</span>
            <h2 class="mb-4 font-extrabold text-indigo-700 text-xl sm:text-3xl tracking-tight">Administrador</h2>
