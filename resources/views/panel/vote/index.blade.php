                ...
                <div class="flex -mx-2 items-end my-2">
                    ...
                    <div class="px-2 w-1/6 md:w-1/12">
                        <div class="transition ease-in duration-200 bg-green-500 hover:bg-green-400 relative"
                            ...
                            <div class="absolute ml-0 -mt-8 sm:ml-4 sm:-mt-12">
                                <img src="{{ asset($candidate->logo) }}" class="w-12"
            ...
            <table class="min-w-full">
                <thead>
                    <tr>
                        ...
                        <th class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-center text-xs leading-4 font-medium text-gray-500 uppercase">
                        %
                        </th>
                </thead>
                    ...
                    @foreach ($candidates as $candidate)
                        <tr>
                            ...
                            <td class="px-6 py-4 border-b border-gray-200">
                                ...
                                <div class="mt-4 lg:mt-0 text-center">
                                    <div class="bg-gray-400 w-32 md:w-full h-4 rounded-lg mt-2 overflow-hidden">
