                    ...
                    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                        <div class="overflow-hidden bg-white shadow-xl dark:bg-gray-800 sm:rounded-lg">
                            <div>
                                ...
                                <div>
                                    <h1 class="text-center">REALIZA TU VOTO EN 4 SENCILLOS  PASOS</h1>
                                </div>
                                <div class="grid grid-cols-1 bg-gray-200 bg-opacity-25 dark:bg-gray-800 md:grid-cols-2">
                                    <div class="p-6">
                                        <div class="flex items-center"><svg fill="none" stroke="currentColor"
                                            ...
                                            <div
                                                ...
                                                <a href="https://laravel.com/docs">Recibe el mensaje con link y código de votación</a>
                                            </div>
                                        </div>
                                        <div class="ml-12">
                                    ...
                                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                                        <div class="flex items-center"><svg fill="none" stroke="currentColor"
                                            ...
                                            <div
                                                class="ml-4 text-lg font-semibold leading-7 text-gray-600 dark:text-gray-200">
                                                Confirme su candidato y listo ya votaste</div>
                                        </div>
                                        <div class="ml-12">
