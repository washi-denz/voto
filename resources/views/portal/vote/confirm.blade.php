    ...
    <div class="flex justify-center">
        <div class="bg-indigo-400 bg-opacity-30 rounded mx-3 shadow-lg p-4 md:w-1/2">
            ...
            <div class="flex-grow text-center">
                ...
                <p class="text-indigo-300 text-sm">{{ $candidate->name }} {{ $candidate->last_name }}</p>
            </div>
        </div>
    </div>
        
    <div class="flex justify-center mt-3">
        <a  href="{{ route('portal.vote.show',$census->id) }}" class="focus:outline-none transition duration-500 w-auto py-2 px-4 font-semibold text-gray-200 bg-indigo-900 hover:bg-indigo-800 ring-2 ring-gray-200 m-2">Atrás</a>
